...
def create_pet(id: str, payload: dict):
    ...
    pets_dict = getattr(pet_type, "pets", None)
    if pets_dict is None:
        pets_dict = db.setdefault("pets_by_type", {}).setdefault(id, {})
    ...
    if pet.name in pets_dict:
        raise HTTPException(409, "pet with this name already exists in this pet-type")
